...
internal class Program
{
    ...
    {
        Console.WriteLine("******* Testando Conta Genérica *******");
        ...
        conta1.sacar(70);
        conta1.exibirConta();
        conta1.sacar(200);          // Tentando sacar mais $ do que tem no saldo
        conta1.exibirConta();
        ...
        conta3.Banco = 341;         // Banco Itaú
        conta3.Agencia = "0425";    // Agência de Barra Bonita
        conta3.Conta = "36958-7";   // Número da Conta
        conta3.depositar(300);
        conta3.Limite = 500;
        conta3.exibirConta();
        conta3.sacar(500);          // Tentando sacar usando o limite
        conta3.exibirConta();
